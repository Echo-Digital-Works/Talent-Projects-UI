            ...
            >
              ...
              <motion.div 
                ...
                style={{
                 ...
                 {[
                   { name: "instagram", url: "https://www.instagram.com/echodigitalworks?igsh=MTRjYW15eGozenFsYg==" },
                   { name: "facebook", url: "https://www.facebook.com/share/1CAVSpAzGr/" },
                   { name: "youtube", url: "https://www.youtube.com/channel/UCz23zHLXYcP3EFgdlagYKXA" },
                   { name: "linkedin", url: "https://www.linkedin.com/company/108436258/admin/inbox/thread/2-YjJmZTYwMTItYTVmYS00OTAyLWE0MWUtZTFiYzI2MDI5YjRkXzEwMA==/" }
                 ].map((social, idx) => (
                   <motion.a 
                     key={social.name}
                     href={social.url}
                     ...
                     onMouseOver={(e) => {
                       ...
                       e.currentTarget.style.color = colors[social.name] || "#0a66c2";
                     }}
              ...
              <motion.div 
                ...
                style={{
                 ...
                 {[
                   ...
                   { name: "linkedin", url: "https://www.linkedin.com/in/talent-projects-949aa9406" },
                   { name: "facebook", url: "https://www.facebook.com/profile.php?id=61561273601161" },
                   { name: "instagram", url: "https://www.instagram.com/talent_projects?igsh=MXFmdm5udmYxYTY2eQ%3D%3D&utm_source=qr" }
                 ].map((social, idx) => (
                   <motion.a 
                     key={social.name}
                     href={social.url}
