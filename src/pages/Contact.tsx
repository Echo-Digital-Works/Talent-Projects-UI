    ...
    <>
      <style>{`
        ...
        .tech-input {
          ...
          background: rgba(15, 23, 42, 0.6); /* Deep slate translucent */
          color: #f8fafc;
          font-size: 0.95rem;
          outline: none;
      ...
      <section id="contact" style={{ 
        background: "#020617", // Deep Obsidian Background
        position: "relative",
        overflow: "hidden",
        padding: "120px 20px"
      }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          >
            <span style={{ 
              ...
              color: "#38bdf8", fontWeight: 700, marginBottom: "16px"
            }}>
              <span style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#38bdf8", boxShadow: "0 0 10px #38bdf8" }} />
              Project Initiation
            </span>
            <h2 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, color: "#f8fafc", marginBottom: "16px", letterSpacing: "-0.02em" }}>
              Book an <span style={{ background: "linear-gradient(135deg, #38bdf8 0%, #8b5cf6 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Expert Consultation</span>
            </h2>
            <p style={{ color: "#94a3b8", fontSize: "clamp(1rem, 2vw, 1.15rem)", maxWidth: "600px", margin: "0 auto", lineHeight: 1.6 }}>
          ...
          >
            ...
            <div className="contact-info">
              ...
              <p style={{ color: "#94a3b8", fontSize: "0.95rem", lineHeight: 1.6, marginBottom: "40px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                <div>
                  ...
                  <p style={{ color: "#e2e8f0", fontSize: "1rem", fontWeight: 500 }}>
                    Echo Digital Works<br/>Tech Park, Block B<br/>Innovation City, 400001
                  </p>
                </div>
                
                <div>
                  <h4 style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em", color: "#64748b", marginBottom: "8px" }}>Comm Links</h4>
                  <p style={{ color: "#e2e8f0", fontSize: "1rem", fontWeight: 500, marginBottom: "4px" }}>+91 98765 43210</p>
                  <p style={{ color: "#e2e8f0", fontSize: "1rem", fontWeight: 500 }}>engineering@echodigital.works</p>
                </div>
              </div>

              {/* Animated Status Indicator */}
              <div style={{ marginTop: "60px", padding: "16px", background: "rgba(15, 23, 42, 0.6)", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.05)", display: "flex", alignItems: "center", gap: "12px" }}>
                <motion.div animate={{ opacity: [1, 0.4, 1] }} transition={{ duration: 2, repeat: Infinity }} style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#10b981", boxShadow: "0 0 10px #10b981" }} />
                <div>
                  <div style={{ color: "#f8fafc", fontSize: "0.85rem", fontWeight: 700 }}>SYSTEMS OPERATIONAL</div>
                  <div style={{ color: "#64748b", fontSize: "0.75rem" }}>Engineers currently online: 4</div>
                </div>
              </div>
            </div>
              ...
              <form style={{ display: "flex", flexDirection: "column", gap: "24px" }} onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="form-grid-2">
                  <div>
                    ...
                    <input type="text" className="tech-input" placeholder="e.g. Alan Turing" required />
                  </div>
                  <div>
                    <label className="tech-label">Email Address</label>
                    <input type="email" className="tech-input" placeholder="alan@example.com" required />
                  </div>
                </div>
                ...
                <div className="form-grid-2">
                  <div>
                    ...
                    <input type="tel" className="tech-input" placeholder="+91 00000 00000" required />
                  </div>
                  <div>
                    <label className="tech-label">Alternate Number (Optional)</label>
                    <input type="tel" className="tech-input" placeholder="+91 00000 00000" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    <select className="tech-input tech-select" style={{ appearance: "none", cursor: "pointer" }} required>
                      <option value="" disabled selected>Select technological domain...</option>
